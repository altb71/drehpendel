...
// 1 Encoder Motor A            PA_6  - nok
// 2 Encoder Motor B            PC_7  - nok
...
public:
    ...
    void reset_encoders() { encoder_motor.reset(); encoder_pendulum.reset(); }
    void write_pwm_motor(float val) { pwm.write(pwm_val); }
